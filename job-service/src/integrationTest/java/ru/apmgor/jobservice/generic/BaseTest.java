package ru.apmgor.jobservice.generic;
...
public abstract class BaseTest {
    ...
    private static final String INIT_JS = "/docker-entrypoint-initdb.d/job-init.js";
    ...
    public static void mongoProperties(final DynamicPropertyRegistry registry) {
        var genUri = String.format(MONGO_URI_FORMAT, mongo.getHost(), mongo.getMappedPort(MONGO_PORT));
        registry.add("spring.data.mongodb.uri", () -> genUri);
    }
}
